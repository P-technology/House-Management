"""
Django settings for House_Reservation project.
...
ROOT_URLCONF = 'House_Reservation.urls'
...
WSGI_APPLICATION = 'House_Reservation.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR,'House_Reservation/static')    
]
